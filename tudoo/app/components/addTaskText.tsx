...
const AddTaskText = () => {
  ...
  return (
    <div className="grid w-full grid-cols-1 gap-3 md:grid-cols-7 md:grid-rows-9 md:gap-0">
      <form action={addTask} className="border-2 border-neutral rounded-full p-4 grid grid-cols-7 col-start-3 col-span-3 row-start-5 ">
