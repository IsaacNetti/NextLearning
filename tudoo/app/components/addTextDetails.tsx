...
const AddTextDetails = () => {
  return (
    <div className='border-x border-b border-neutral grid grid-cols-3'>
      <input type="text" name="details" placeholder='Details' className=' px-3 md:px-5 my-3.5 focus:outline-none'/> 
      ...
      <div className='self-center justify-self-end'>
        ...
        <label htmlFor="important" className='px-2 md:pr-5'>Important</label>
      </div>
    </div>
  )
}
